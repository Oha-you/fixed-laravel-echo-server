...
var Server = (function () {
    ...
    Server.prototype.init = function () {
        ...
        return new Promise(function (resolve, reject) {
            _this.serverProtocol().then(function () {
                ...
                log_1.Log.success("Running at ".concat(host, " on port ").concat(_this.getPort()));
                resolve(_this.io);
    ...
    Server.prototype.httpServer = function (secure) {
        ...
        var httpServer = secure ? https.createServer(this.options, this.express) : http.createServer(this.express);
